...
enum class StrId : uint16_t {
  ...
  STR_PRESET_CLASSIC,
  STR_PRESET_AIRY,
  STR_PRESET_LARGE_PRINT,
  STR_PRESET_NIGHT_COMFORT,
  STR_REFRESH_MODE,
  STR_REFRESH_MODE_FULL,
  STR_REFRESH_MODE_BALANCED,
  STR_REFRESH_MODE_AGGRESSIVE,
  STR_PERFORMANCE_MODE,
  STR_MODE_BATTERY_SAVER,
  STR_MODE_BALANCED,
  STR_MODE_PERFORMANCE,
  STR_CONTROL_PROFILE,
  STR_PROFILE_DEFAULT,
  STR_PROFILE_LEFT_HANDED,
  STR_PROFILE_ONE_HAND_COMMUTE,
  STR_PROFILE_MINIMAL,
  STR_BUTTON_TEST,
  STR_LIBRARY_SHELF,
  STR_SHELF_ALL,
  STR_SHELF_CONTINUE_READING,
  STR_SHELF_IN_PROGRESS,
  STR_SHELF_UNREAD,
  STR_SHELF_RECENTLY_ADDED,
  STR_IN_PROGRESS,
  STR_UNREAD,
  STR_RECENTLY_ADDED,
